...
return -- Obisidion integration to neovim
{
	...
	event = {
		...
		"BufNewFile " .. vim.fn.expand("~") .. "/Documents/Obsidian Vault/Quick Notes/**.md",
	},
	dependencies = {
		-- Required.
	...
	keys = {
		...
		{ "<leader>ot", "<cmd>ObsidianTemplate<cr>", desc = "New template", mode = "n" },
	},
	opts = {
		workspaces = {
			{
				name = "nvim",
				path = vim.fn.expand("~") .. "/Documents/Obsidian Vault/nvim",
			},
			{
				name = "tmux",
				path = vim.fn.expand("~") .. "/Documents/Obsidian Vault/tmux",
			},
			{
				name = "code",
				path = vim.fn.expand("~") .. "/Documents/Obsidian Vault/code",
			},
		},
		...
		-- Optional, boolean o a function that takes a filename and returns a boolean.
		...
		ui = {
			...
			hl_groups = {
				...
				ObsidianDone = { bold = true, fg = mocha.sky },
				ObsidianRightArrow = { bold = true, fg = mocha.peach },
				ObsidianTilde = { bold = true, fg = mocha.flamingo },
				...
				ObsidianTag = { italic = true, fg = mocha.sky },
				ObsidianHighlightText = { bg = mocha.yellow },
			},
