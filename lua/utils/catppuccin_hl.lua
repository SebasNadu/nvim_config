  ...
  highlight_overrides = {
    all = function(colors)
      return {
        ...
        NeoTreeTabActive = { fg = colors.text, bg = "" },
        NeoTreeTabInactive = { fg = colors.surface2, bg = colors.crust },
        NeoTreeTabSeparatorActive = { fg = colors.mantle, bg = "" },
        NeoTreeTabSeparatorInactive = { fg = colors.crust, bg = "" },
        NeoTreeWinSeparator = { fg = colors.base, bg = "" },
        NormalFloat = { bg = "" },
        Pmenu = { bg = "", fg = "" },
        PmenuSel = { bg = colors.surface0, fg = "" },
        TelescopePreviewBorder = { bg = "", fg = colors.crust },
        TelescopePreviewNormal = { bg = "" },
        TelescopePreviewTitle = { fg = colors.crust, bg = "" },
        TelescopePromptBorder = { bg = "", fg = colors.surface0 },
        TelescopePromptCounter = { fg = colors.mauve, style = { "bold" } },
        TelescopePromptNormal = { bg = "" },
        TelescopePromptPrefix = { bg = colors.surface0 },
        TelescopePromptTitle = { fg = colors.surface0, bg = colors.surface0 },
        TelescopeResultsBorder = { bg = "", fg = colors.mantle },
        TelescopeResultsNormal = { bg = "" },
        TelescopeResultsTitle = { fg = colors.mantle, bg = "" },
        TelescopeSelection = { bg = colors.surface0 },
        VertSplit = { bg = "", fg = colors.surface0 },
